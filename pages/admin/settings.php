...
$friendlyLabels = [
    ...
    'google_allowed_emails' => 'Allowed Google Emails (one per line)',
...
$helpTexts = [
    ...
    'google_client_id' => 'Get from console.cloud.google.com → Credentials',
    'google_client_secret' => 'Keep this secret! From Google Cloud Console',
    'google_allowed_emails' => 'Only these emails can login via Google. One per line. Leave empty = any Google account linked to admin user.',
